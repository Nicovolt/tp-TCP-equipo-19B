         ...
         <asp:Repeater ID="repeaterCarrito" runat="server">
             <ItemTemplate>
                 <tr>
                     ...
                     <td>
                         <asp:Button ID="btnEliminar" runat="server" CssClass="btn btn-danger" Text="Quitar" OnClick="btnEliminar_Click" CommandArgument='<%# Eval("Id_producto") %>' CommandName="idArticulo" /></td>
